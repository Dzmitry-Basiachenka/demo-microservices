...
assertCurl 200 "curl -X POST http://$STORAGE_HOST:$STORAGE_PORT/$STORAGE_PATH -H 'Content-Type: application/json' --data '$storage' -s"
...
echo
echo Delete storage
assertCurl 200 "curl -X DELETE http://$STORAGE_HOST:$STORAGE_PORT/$STORAGE_PATH?ids=$storageId -s"
echo
